<template>
  <div class="p-4">
    <CollapseContainer class="mt-4" title="采集单元">
      <!-- <Tag>采集单元：</Tag> -->
      <a-select
      ...
      <a-button class="mr-2"> 重置采集单元录波列表 </a-button>
      <a-button class="mr-2"> 获取采集单元录波列表 </a-button>
      <a-button class="mr-2"> 获取redis已读取到的录波列表 </a-button>
      <a-button class="mr-2"> 关闭其他 </a-button>
    </CollapseContainer>
